...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-neutral-800 bg-black/95 backdrop-blur-sm">
      <Container className="py-4">
        <nav className="flex items-center justify-between">
          ...
          <Link
            href="/contact"
            className="hidden md:inline-block px-6 py-3 border border-[#ff2d75] text-[#ff2d75] hover:bg-[#ff2d75] hover:text-black"
          >
            Let&apos;s Talk
          </Link>
